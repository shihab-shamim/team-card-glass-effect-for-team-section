...
const Style = ({
  ...
  var _styles$columnGap, _styles$rowGap, _styles$glass$blur, _styles$glass$blur2, _styles$social$gap;
  const {
    styles = {},
    alignment = 'center'
  } = attributes || {};
  ...
  const cardShadow = (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getMultiShadowCSS)(styles?.card?.shadow);
  const cardHoverShadow = (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getMultiShadowCSS)(styles?.card?.hoverShadow);
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
		...
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', styles?.button?.typo)?.googleFontLink || ''}
		...
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(buttonSl, styles?.button?.typo)?.styles || ''}
		...
		${wrapperSl} {
			...
			column-gap: ${(_styles$columnGap = styles?.columnGap) !== null && _styles$columnGap !== void 0 ? _styles$columnGap : 30}px;
			row-gap: ${(_styles$rowGap = styles?.rowGap) !== null && _styles$rowGap !== void 0 ? _styles$rowGap : 30}px;
		...
		${cardSl} {
			...
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBorderCSS)(styles?.card?.border)}
		...
		${glassSl} {
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(styles?.glass?.bg)}
			height: ${styles?.glass?.height || '180px'};
			padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.glass?.padding)};
			text-align: ${styles?.glass?.textAlign || 'center'};
			border: 1px solid ${styles?.glass?.borderColor || 'rgba(255,255,255,0.2)'};
			backdrop-filter: blur(${(_styles$glass$blur = styles?.glass?.blur) !== null && _styles$glass$blur !== void 0 ? _styles$glass$blur : 15}px);
			-webkit-backdrop-filter: blur(${(_styles$glass$blur2 = styles?.glass?.blur) !== null && _styles$glass$blur2 !== void 0 ? _styles$glass$blur2 : 15}px);
		}
		...
		${socialListSl} {
			gap: ${(_styles$social$gap = styles?.social?.gap) !== null && _styles$social$gap !== void 0 ? _styles$social$gap : 12}px;
		...
		${buttonSl} {
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(styles?.button?.bg)}
			...
			margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(styles?.button?.margin)};
		}

		${buttonSl}:hover {
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(styles?.button?.hoverBg)}
